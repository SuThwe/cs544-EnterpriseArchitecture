 ...
 public class Client implements CommandLineRunner {
     ...
     public void run(String... args) throws Exception {
         ...
         System.out.println("\n------ Customer id " + customer1.getId() + " is saved successfully ---------");
         System.out.println(customer1);
         System.out.println("------ Customer id " + customer2.getId() + " is saved successfully ---------");
         ...
         System.out.println("\n------ Food id 1,2,3 is saved successfully ---------");
         ...
         order.setSpecialNote("Spicy");
         order.setTotalPrice(order.calculateTotalCost(order.getFoodList()));
         orderService.add(order);

         System.out.println("\n------ Order id " + order.getId() + " is saved successfully ---------");
