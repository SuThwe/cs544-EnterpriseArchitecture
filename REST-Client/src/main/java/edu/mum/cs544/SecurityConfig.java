...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/api/foods/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT,"/api/foods/**").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE,"/api/foods/**").hasRole("ADMIN")
                .anyRequest()
                .authenticated()
                .and()
                .httpBasic();
